...
let p1AttackButton = document.getElementById("p1AttackBtn");
let p1HealButton = document.getElementById("p1HealBtn");
let p2AttackButton = document.getElementById("p2AttackBtn");
let p2HealButton = document.getElementById("p2HealBtn");
...
let name1 = `${prompt("What is your name Player1")}`;
let name2 = `${prompt("What is your name Player2")}`;
// ** Create 2 players using the player class **
const player1 = new Player(name1, 100, 10);
// console.log(player1.name)
const player2 = new Player(name2, 100, 10);
...
// Add functionality where players can click button to attack OR heal
// ** Player 1 Controls **
p1AttackButton.addEventListener("click", function () {
  // if you click q AND enemy health is greater than 0 AND isOver is still false then stike()
...
p1HealButton.addEventListener("click", function () {
  // if you click a button AND the player health is greater than 0 AND isOver is still false then heal()
  if (p2.health > 0 && game.isOver == false) {
    // After healing then play heal sound
    p1.heal(p1);
    document.getElementById("p1heal").play();
...
p2AttackButton.addEventListener("click", function () {
  // if you click p button AND enemy health is greater than 0 AND isOver is still false then stike()
...
p2HealButton.addEventListener("click", function () {
  // if you click l button AND the player health is greater than 0 AND isOver is still false then heal()
  if (p1.health > 0 && game.isOver == false) {
    // After healing then play heal sound
    p2.heal(p2);
    document.getElementById("p2heal").play();
